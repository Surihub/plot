...
try:
    tab1, tab2, tab3 = st.tabs(["seaborn 데이터셋", "causaldata 데이터셋", "파일 업로드"])
...
@st.cache_data()
def adjust_var(df, selected_columns):
...
selected_columns = select_col(df)
adjust_var(df, selected_columns)
